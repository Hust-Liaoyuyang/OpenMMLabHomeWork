...
# 读取JSON文件
with open(r'D:\workspace\mmdetection\balloon_dataset\balloon\val\via_region_data.json') as f:
...
for image_id, image_info in annotations.items():
    ...
    # 获取图像的height和width
    img = cv2.imread(os.path.join(r'D:\workspace\mmdetection\balloon_dataset\balloon\val', filename))
...
# 保存COCO格式文件
with open(r'D:\workspace\mmdetection\balloon_dataset\balloon\val\balloon_train.json', 'w') as f:
